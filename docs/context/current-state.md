...
- **Frontend Service (`/apps/frontend`)**: Scaffolded using Next.js App Router (TypeScript + Tailwind CSS v4). Setup dependencies, hybrid MSW interception router, HSL variables theme engine, global Layout with Outfit/JetBrains fonts, and custom glassmorphic components (Button, Card, ProgressBar, Toast alerts). All assets build cleanly under Turbopack.
