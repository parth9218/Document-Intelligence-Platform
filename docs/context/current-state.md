...
- **Frontend Phase 3 (Batch Upload & Ingestion)**: In Progress. Task F3.1 (Drag-and-Drop Picker UI) and Task F3.2 (Batch Initialization & Queue Hook) are complete. Next is Task F3.3 (Multipart Presigned POST S3 Upload & Confirmation Handback).
